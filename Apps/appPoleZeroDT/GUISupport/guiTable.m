function handle = guiTable(hObject,callback,colWidths,colFormats,colHeaders,colEdit)
...
% All rights reserved.
%
  hTable = uitable('Parent',hObject,'ColumnWidth',colWidths,...
