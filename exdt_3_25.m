...
L = 5;                       % Edit this line to experiment
Omg = [-1:0.005:1]*pi+eps;   % Use 'eps' to avoid division by zero
XDTFT = sin(0.5*Omg*(2*L+1))./sin(0.5*Omg);   % See Example 3.25
Gx = XDTFT.*XDTFT;
...
% Compute the percentage of signal energy in the frequency interval
% -\pi/10< Omega< pi/10
pow2/pow1